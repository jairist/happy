...
class EvaluacionProvider {
  ...
  final List<String> _proveedores = <String>[''];
  ...
  Future<bool> crearEvaluacion(EvaluacionModelo evaluacionModelo) async {
    ...
    final resp =
        await http.post(url, body: evaluacionModeloToJson(evaluacionModelo));

    final decodedData = json.decode(resp.body);
    print('Evaluacion $decodedData');
  ...
  Future<String> subirImagen(File imagen) async {
    final url = Uri.parse(
        'https://api.cloudinary.com/v1_1/do0twoors/image/upload?upload_preset=b9rkz6i4');
