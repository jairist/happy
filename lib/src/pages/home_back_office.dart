...
import 'package:happy/src/pages/settings_page.dart';
  ...
  Widget listDrawerItems(bool drawerStatus) {
    return ListView(
      children: <Widget>[
        ...
        createMenuOption(drawerStatus, 2, "Agregar Usuario", Icon(Icons.add)),
        createMenuOption(drawerStatus, 3, "Salir", Icon(Icons.exit_to_app))
      ]);
