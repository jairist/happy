...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(children: <Widget>[_creaFondo(context), _loginForm(context)]),
    );
  }
      ...
      child: Column(
        children: <Widget>[
          ...
          FlatButton(
            ...
            onPressed: () =>
                Navigator.pushReplacementNamed(context, 'resetear'),
          ),
          FlatButton(
  ...
  Container contanierWithdDimension(
      Size size, LoginBloc bloc, double dimesionWidth) {
    return Container(
  ...
  _login(LoginBloc bloc, BuildContext context) async {
    ...
    if (info['ok']) {
      ...
      loginInfo.lastLoginDate = formatted;
      loginInfo.email = bloc.email;
      int id = await helper.insert(loginInfo);

      List<Map> list = await helper.queryInfoUserAll();
      print('$list');
      ...
      utils.mostrarAlerta(context,
          'Email o clave incorrecta, en caso de no recordar la clave, puedes resetearla');
    }
