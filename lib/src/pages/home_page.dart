      ...
      body: Stack(
        children: <Widget>[
          ...
          SingleChildScrollView(
            child: Column(
              children: <Widget>[_titulos(bloc), _botonesRedondeados()],
            ),
          )
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text('Selecciona el servio a evaluar.',
              style: TextStyle(
                color: Colors.white,
              )),
        ],
      ...
      children: [
        TableRow(children: [
          ...
          _crearBotonRedondeados(
              Colors.orangeAccent, Icons.directions_bus, 'Transporte'),
        ]),
        TableRow(children: [
          _crearBotonRedondeados(Colors.yellowAccent, Icons.games, 'Juegos'),
          _crearBotonRedondeados(
              Colors.greenAccent, Icons.local_gas_station, 'Combustible'),
        ]),
        TableRow(children: [
          _crearBotonRedondeados(
              Colors.lightBlueAccent, Icons.healing, 'Salud'),
          _crearBotonRedondeados(
              Colors.lightGreenAccent, Icons.laptop_mac, 'Laptop'),
        ]),
      ],
    );
  }
